...
<!--                todo TODO тут текущий город-->
              ...
              <p class="text__p">
                CARRO дает возможность оформить автокредит без первоначального взноса и пользоваться автомобилем уже сегодня. Мы выступаем в качестве кредитного брокера и осуществляем подбор проверенных автосалонов, выбираем банковские предложения с наиболее выгодными для клиента условиями.
