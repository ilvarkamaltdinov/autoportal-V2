        ...
        <div class="sitemap__block grid__col-12">
          <ol class="text__o-list">
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                <li class="text__o-list-item">
                  ...
                  обработки
                  персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые «{{$settings.dealer_title}}»
                  (далее
                  –
                  Администрация сайта), действует в отношении всей информации, которую сайт {{ $settings.dealer_anchor }} (далее – {{ $settings.dealer_anchor }} )
                  расположенный на доменном имени {{ $settings.dealer_anchor }}  (а также его субдоменах), может получить о Пользователе во
                  время
                  использования сайта {{ $settings.dealer_anchor }}  (а также его субдоменов), его программ и его продуктов.
                </li>
              </ol>
            </li>
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                ...
                <li class="text__o-list-item">
                  ...
                  {{ $settings.dealer_anchor }} ,
                  действующие от имени «ООО Ю-СТАЙЛ», которые организуют и (или) осуществляют обработку персональных
                  данных,
                  а
                ...
                <li class="text__o-list-item">
                  «Сайт {{ $settings.dealer_anchor }} » - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по
                  уникальному адресу (URL): {{ $settings.dealer_anchor }} , а также его субдоменах.
                </li>
                <li class="text__o-list-item">
                  «Субдомены» - это страницы или совокупность страниц, расположенные на доменах третьего уровня,
                  принадлежащие сайту {{ $settings.dealer_anchor }} , а также другие временные страницы, внизу который указана контактная
                  информация
                  Администрации
                </li>
                <li class="text__o-list-item">
                  «Пользователь сайта {{ $settings.dealer_anchor }}  » (далее Пользователь) – лицо, имеющее доступ к сайту {{ $settings.dealer_anchor }} ,
                  посредством
                  сети Интернет и использующее информацию, материалы и продукты сайта {{ $settings.dealer_anchor }} .
                </li>
                <li class="text__o-list-item">
                ...
                <li class="text__o-list-item">
                  ...
                  доступ на {{ $settings.dealer_anchor }} .
                </li>
                <li class="text__o-list-item">
            ...
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                <li class="text__o-list-item">
                  Использование сайта {{ $settings.dealer_anchor }}  Пользователем означает согласие с настоящей Политикой конфиденциальности
                  и
                ...
                <li class="text__o-list-item">
                  ...
                  использование
                  сайта {{ $settings.dealer_anchor }}  .
                </li>
                <li class="text__o-list-item">
                  Настоящая Политика конфиденциальности применяется к сайту {{ $settings.dealer_anchor }} . {{ $settings.dealer_anchor }}  не контролирует и не
                  несет
            ...
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                <li class="text__o-list-item">
                  ...
                  по
                  запросу
                  Администрации при регистрации на сайте {{ $settings.dealer_anchor }} , при подписке на информационную e-mail рассылку или
                  при
                  оформлении заказа.
                </li>
                <li class="text__o-list-item">
                  Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности,
                  предоставляются Пользователем путём заполнения форм на сайте {{ $settings.dealer_anchor }}  и включают в себя следующую
                  информацию:
                </li>
                <li class="text__o-list-item">
                ...
                <li class="text__o-list-item">
                  {{ $settings.dealer_anchor }}  защищает Данные, которые автоматически передаются при посещении страниц:
                  <br/>
                  - IP адрес;
                  <br/>
                ...
                <li class="text__o-list-item">
                  {{ $settings.dealer_anchor }}  осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация используется
                  с
            ...
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                ...
                <li class="text__o-list-item">
                  ...
                  использования сайта {{ $settings.dealer_anchor }} , оказания услуг и обработки запросов и заявок от Пользователя.
                </li>
                <li class="text__o-list-item">
                ...
                <li class="text__o-list-item">
                  Создания учетной записи для использования частей сайта {{ $settings.dealer_anchor }} , если Пользователь дал согласие на
                  создание учетной записи.
                </li>
                <li class="text__o-list-item">
                  Предоставления Пользователю эффективной технической поддержки при возникновении проблем, связанных с
                  использованием сайта {{ $settings.dealer_anchor }} .
                </li>
                <li class="text__o-list-item">
                  Предоставления Пользователю с его согласия специальных предложений, информации о ценах, новостной
                  рассылки и иных сведений от имени сайта {{ $settings.dealer_anchor }} .
                </li>
                <li class="text__o-list-item">
            ...
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                ...
                <li class="text__o-list-item">
                  ...
                  в
                  частности, операторам электросвязи, исключительно в целях выполнения заказа Пользователя, оформленного
                  на
                  сайте
                  {{ $settings.dealer_anchor }} .
                </li>
            ...
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                ...
                <li class="text__o-list-item">
                  ...
                  сайта {{ $settings.dealer_anchor }} , и давать согласие на их обработку.
                </li>
                <li class="text__o-list-item">
                ...
                <li class="text__o-list-item">
                  Пользователь имеет право на получение у Администрации информации, касающейся обработки его
                  персональных
                ...
                <li class="text__o-list-item">
                  ...
                  возможными способами переданных персональных данных Пользователя, за исключением п.п. 5.2 и 5.3.
                  настоящей
                ...
                <li class="text__o-list-item">
                  ...
                  защите
                  прав
                  субъектов персональных данных на период проверки, в случае выявления недостоверных персональных данных
                  или
            ...
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                ...
                <li class="text__o-list-item">
                  В случае утраты или разглашения Конфиденциальной информации Администрация не несёт ответственность,
                  если
                ...
                <li class="text__o-list-item">
                  Пользователь признает, что ответственность за любую информацию (в том числе, но не ограничиваясь:
                  файлы с
                  данными, тексты и т. д.), к которой он может иметь доступ как к части сайта {{ $settings.dealer_anchor }} , несет лицо,
                  предоставившее
                  такую информацию.
                </li>
                <li class="text__o-list-item">
                  Пользователь соглашается, что информация, предоставленная ему как часть сайта {{ $settings.dealer_anchor }} , может являться
                  объектом интеллектуальной собственности, права на который защищены и принадлежат другим Пользователям,
                  партнерам
                  или рекламодателям, которые размещают такую информацию на сайте {{ $settings.dealer_anchor }} .
                ...
                <li class="text__o-list-item">
                  В отношение текстовых материалов (статей, публикаций, находящихся в свободном публичном доступе на
                  сайте
                  {{ $settings.dealer_anchor }} ) допускается их распространение при условии, что будет дана ссылка на {{ $settings.dealer_anchor }} .
                </li>
                <li class="text__o-list-item">
                  ...
                  коммуникационных данных, содержащихся на сайте {{ $settings.dealer_anchor }}  или передаваемых через него.
                </li>
                <li class="text__o-list-item">
                ...
                <li class="text__o-list-item">
                  ...
                  {{ $settings.dealer_anchor }} , включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого согласия
                  владельца
                  авторского права.
                </li>
              </ol>
            ...
            <li class="text__o-list-item text__o-list-item--heading">
              ...
              <ol class="text__o-list">
                ...
                <li class="text__o-list-item">
                  Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте {{ $settings.dealer_anchor }}, если иное
                  не
                  предусмотрено новой редакцией Политики конфиденциальности.
                </li>
                <li class="text__o-list-item">
                  Все предложения или вопросы касательно настоящей Политики конфиденциальности следует сообщать по
                  адресу:
                  {{ $settings.email }}.
                </li>
                <li class="text__o-list-item">
                  Действующая Политика конфиденциальности размещена на странице по адресу https://{{$settings.dealer_anchor}}/privacy.
                  <br/>
